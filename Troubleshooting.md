...
## Script will not run or shows "not digitally signed"
...
C:\Users\USERNAME\Desktop\openclaw-wipe
...
### Cause
GitHub ZIP downloads often create a double-nested folder:
...
### Meaning
This is good. It means OpenClaw is no longer on your PATH.
...
Remove-Item "PATH_SHOWN_BY_SCRIPT" -Force
...
## Script prints garbage characters like "??"
...
- contain ASCII only
- are saved as UTF-8 without BOM
...
### Cause
This happened in older versions that used wildcard deletion such as:

Get-ChildItem -Recurse -Filter "openclaw*"

### Fix
The corrected version never deletes based on name patterns. Update to the latest version of the repo.
